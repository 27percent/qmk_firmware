...
[BASE] = KEYMAP(
    ...
    // MCP23018 chip 1
    KC_Z,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_Y,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_X,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_W,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_V,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_U,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_T,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H,
    KC_S,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_G,    KC_H
